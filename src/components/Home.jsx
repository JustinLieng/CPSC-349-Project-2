...
const Home = () => {
  ...
  return (
    <div>
      ...
      <iframe className="iframe" src="/Cat Box/" width="10%" title="Cat Box" />
      <iframe className="iframe" src="/Cat Box 2/" width="10%" title="Cat Box 2" />
      <div className="plate">
        ...
        <img src="/nike.jpg" alt="Picture of Justin" width="400" />
