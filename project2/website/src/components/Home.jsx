...
const Home = () => {
  return (
    <div>
        <div>
        <img class="speechbubble" src="./src/pictures/speech bubble.gif" width="700"></img>
        </div>
        <iframe class="iframe" src="./src/3D Models/Banana Cat/" width="10%"></iframe>
        <iframe class="iframe" src="./src/3D Models/Cat Box/" width="10%"></iframe>
        <iframe class="iframe" src="./src/3D Models/Cat Box 2/" width="10%"></iframe>
    <div class="home">
      ...
      <img src="./src/pictures/nike.jpg" alt="Picture of Justin" width="400"></img>
      ...
      <p>I am currently 22 years old and studying Computer Science at California State University Fullerton. 
        ...
        at all. I have no regrets going into this field not just because I enjoy it but becayse I don't see myself doing
        anything else. I hope you enjoy my portfolio website that I've created, please take a look around and come again!
      </p>
      <h1>Skills</h1>
      <p>Some of my programming related skill include: </p>
      <h2>Languages</h2>
